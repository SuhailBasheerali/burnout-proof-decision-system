...
## 👥 Target Users (By Frontend Design)

**Primary Focus: Academic Burnout-Proof Decision Making**

This system is designed for students, educators, and academic advisors facing decisions that balance academic growth with psychological sustainability.

### 1. **Undergraduate & Graduate Students**
- **Decision Context:** Choosing majors, course loads, research programs, internships, study abroad programs
- **Pain Point:** Academic culture rewards overcommitment; students choose prestigious-but-unsustainable paths
- **Frontend Feature:** Growth (learning value, career advancement) vs. Sustainability (workload, health, sleep)
- **What they need:** Permission to choose "less impressive" but sustainable options without guilt

### 2. **Burned-Out Students**
- **Who:** Students in high-pressure programs (pre-med, engineering, CS, research-heavy) recognizing unsustainability
- **Pain Point:** Stuck between "competitive" (burnout risk) and "dropout" (lose opportunities) options
- **Frontend Feature:** Explicit zone classification (EXECUTE_FULLY vs TIME_BOX vs LIGHT_RECOVERY vs AVOID)
- **What they need:** Framework to recognize burnout traps before it's too late

### 3. **PhD/Graduate Decision-Makers**
- **Who:** Considering PhD programs, research labs, graduate schools, thesis topics
- **Pain Point:** Academic research culture normalizes 60+ hour weeks; hard to evaluate sustainability
- **Frontend Feature:** Sensitivity analysis shows which criteria matter most + stability grading
- **What they need:** Objective tool to evaluate "prestigious but unsustainable" vs "balanced growth"

### 4. **Academic Advisors & Mentors**
- **Who:** Faculty advisors, academic counselors, program directors helping students decide
- **Pain Point:** Need structured framework to help students recognize burnout risks
- **Frontend Feature:** Criteria customization + documented decision logic they can teach
- **What they need:** Evidence-based system to guide students away from burnout traps

### 5. **Parents & Family Members**
- **Who:** Supporting students through academic decision-making
- **Pain Point:** Pressure to maximize prestige/credentials without understanding sustainability costs
- **Frontend Feature:** Visual metrics + AI reflection shows real-world burnout risks
- **What they need:** Objective data to push back on "just work harder" mentality

### 6. **Educators & Program Designers**
- **Who:** Professors, program coordinators designing academic pathways
- **Pain Point:** Want to create ambitious programs without burning out students
- **Frontend Feature:** Decision framework shows how to balance challenge + sustainability
- **What they need:** Model for designing sustainable excellence

---

## 🎓 Why Academic Context? Design Decisions

**Growth vs. Sustainability Framing**
→ Academic life naturally separates into skill/credential gain (growth) and time/energy costs (sustainability)

**Burnout-Aware Risk Assessment**
→ Academic burnout is specific: perfectionism + imposter syndrome + competitive culture + precarious mental health

**Zone Classification (EXECUTE_FULLY → AVOID)**
→ Maps to academic choices: "take this program fully" vs "part-time/lighter load" vs "skip this opportunity"

**Sensitivity Analysis**
→ Shows students which academic factors matter most to them (GPA weight vs. life balance weight)

**AI Reflection (Absolem)**
→ Optional wisdom layer: reflects on burnout risks students often ignore, acts as mental health advocate

**Multi-Step Wizard**
→ Breaks complex academic decision into: Define goal → List options → Score criteria → Get recommendation → Reflect
